...
describe('Our first tests', () => {
    ...
    it('then and wrap methods', () => {
        ...
        cy.contains('nb-card', 'Block form').then( form => {
            cy.wrap(form).find('[placeholder="First Name"]').type('Alec')
            cy.wrap(form).find('[placeholder="Last Name"]').type('Reid')
            cy.wrap(form).find('[placeholder="Email"]').type('Test@test.com')
            cy.wrap(form).find('[placeholder="Website"]').type('testing.com')
